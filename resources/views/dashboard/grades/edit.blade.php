...
@section('title', __('grades.edit_grade'))
@section('heading', __('grades.edit_grade'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.grades.update', $grade) }}" class="space-y-5">
            @csrf
            @method('PUT')
