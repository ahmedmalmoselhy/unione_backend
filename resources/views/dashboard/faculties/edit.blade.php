...
@section('title', __('faculties.edit_faculty'))
@section('heading', __('faculties.edit_faculty'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.faculties.update', $faculty) }}" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
