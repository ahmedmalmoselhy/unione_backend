...
@section('title', __('sections.new_section'))
@section('heading', __('sections.new_section'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.sections.store') }}" class="space-y-5">
            @csrf

            @include('dashboard.sections._form', ['section' => null])
