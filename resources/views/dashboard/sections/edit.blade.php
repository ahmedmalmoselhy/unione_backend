...
@section('title', __('sections.edit_section'))
@section('heading', __('sections.edit_section'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.sections.update', $section) }}" class="space-y-5">
            @csrf
            @method('PUT')
