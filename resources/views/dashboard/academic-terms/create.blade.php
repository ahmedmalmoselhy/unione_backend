...
@section('title', __('academic_terms.new_term'))
@section('heading', __('academic_terms.new_term'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.academic-terms.store') }}" class="space-y-5">
            @csrf

            @include('dashboard.academic-terms._form', ['academicTerm' => null])
