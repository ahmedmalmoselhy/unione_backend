...
<div class="w-full max-w-sm">
    ...
    <div class="bg-white rounded-2xl shadow-sm border border-gray-200 p-8">
        ...
        <h2 class="text-lg font-semibold text-gray-900 mb-1 text-center">Set your new password</h2>
        <p class="text-sm text-gray-500 text-center mb-6">Your account requires a password change before you can continue.</p>
        ...
        <form method="POST" action="{{ route('dashboard.password.update') }}" class="space-y-5" novalidate>
            ...
            <div>
                ...
                <input id="password_confirmation" type="password" name="password_confirmation" required autocomplete="new-password"
                       class="w-full px-3.5 py-2.5 rounded-lg border text-sm border-gray-300 focus:border-blue-500 focus:ring-blue-200 focus:outline-none focus:ring-2"/>
            </div>
