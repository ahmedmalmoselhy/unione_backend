...
<div class="grid grid-cols-1 md:grid-cols-2 gap-5">
    ...
    <div class="md:col-span-2">
        <label class="block text-sm font-medium text-gray-700 mb-1.5">Department Logo</label>
    ...
    {{-- Head (employee) --}}
    <div class="md:col-span-2">
        <label for="head_id" class="block text-sm font-medium text-gray-700 mb-1.5">Manager <span class="text-xs font-normal text-gray-400">(optional — must be an employee)</span></label>
        <select
            id="head_id"
            name="head_id"
            class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors
