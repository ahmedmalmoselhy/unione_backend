...
@section('title', __('departments.new_academic_department'))
@section('heading', __('departments.new_academic_department'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.departments.store') }}" enctype="multipart/form-data" class="space-y-5">
            ...
            @include('dashboard.departments._form_academic', ['department' => null])
            ...
            <div class="flex items-center justify-end gap-3 pt-2 border-t border-gray-100 dark:border-gray-700">
                ...
                <button type="submit"
                    ...
                    {{ __('departments.create_academic_department') }}
                </button>
            </div>
        </form>
