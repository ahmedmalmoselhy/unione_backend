...
<div class="mb-6">
    <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">{{ __('students.profile_picture') }}</h3>
    <div>
        ...
        @enderror
        <p class="mt-1.5 text-xs text-gray-400 dark:text-gray-500">{{ __('students.photo_hint') }}</p>
    </div>
</div>

{{-- Section: Personal Information --}}
<div class="mb-6">
    <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">{{ __('students.personal_information') }}</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">

        {{-- National ID --}}
        <div>
            <label for="national_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.national_id') }} <span class="text-red-500">*</span></label>
            <input
                id="national_id"
                type="text"
                name="national_id"
        ...
        {{-- First Name --}}
        <div>
            <label for="first_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.first_name') }} <span class="text-red-500">*</span></label>
            <input
                id="first_name"
                type="text"
                name="first_name"
        ...
        {{-- Last Name --}}
        <div>
            <label for="last_name" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.last_name') }} <span class="text-red-500">*</span></label>
            <input
                id="last_name"
                type="text"
                name="last_name"
        ...
        {{-- Phone --}}
        <div>
            <label for="phone" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.phone') }} <span class="text-xs font-normal text-gray-400">({{ __('common.optional') }})</span></label>
            <input
                id="phone"
                type="text"
                name="phone"
        ...
        {{-- Gender --}}
        <div>
            <label for="gender" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.gender') }} <span class="text-red-500">*</span></label>
            <select
                id="gender"
                name="gender"
                required
        ...
        {{-- Date of Birth --}}
        <div>
            <label for="date_of_birth" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.date_of_birth') }} <span class="text-xs font-normal text-gray-400">({{ __('common.optional') }})</span></label>
            <input
                id="date_of_birth"
                type="date"
                name="date_of_birth"
        ...
        @if($isEdit)
            <div class="flex items-center gap-3">
                ...
                />
                <label for="is_active" class="text-sm font-medium text-gray-700 dark:text-gray-300">{{ __('students.active_account') }}</label>
            </div>
        @endif
    </div>
</div>
...
<div class="mb-6">
    ...
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">
        <div>
            <label for="password" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('common.password') }} @if(!$isEdit)<span class="text-red-500">*</span>@endif</label>
            <input
                id="password"
                type="password"
                name="password"
        ...
        <div>
            <label for="password_confirmation" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('common.confirm_password') }}</label>
            <input
...
<div class="mb-6">
    <h3 class="text-sm font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-4">{{ __('students.academic_information') }}</h3>
    <div class="grid grid-cols-1 md:grid-cols-2 gap-5">

        {{-- Student Number --}}
        <div>
            <label for="student_number" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.student_number_full') }} <span class="text-red-500">*</span></label>
            <input
                id="student_number"
                type="text"
                name="student_number"
                ...
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
                       {{ $errors->has('student_number') ? 'border-red-400 bg-red-50 focus:ring-red-300' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 dark:focus:ring-blue-800' }}
                       focus:outline-none focus:ring-2"
            />
        ...
        {{-- Faculty --}}
        <div>
            <label for="faculty_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.faculty') }} <span class="text-red-500">*</span></label>
            <select
                id="faculty_id"
                name="faculty_id"
                required
        ...
        {{-- Department --}}
        <div>
            <label for="department_id" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.department') }} <span class="text-xs font-normal text-gray-400">({{ __('common.optional') }})</span></label>
            <select
                id="department_id"
                name="department_id"
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
        ...
        {{-- Academic Year --}}
        <div>
            <label for="academic_year" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.academic_year') }} <span class="text-red-500">*</span></label>
            <input
                id="academic_year"
                type="number"
                name="academic_year"
        ...
        {{-- Semester --}}
        <div>
            <label for="semester" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.semester') }} <span class="text-red-500">*</span></label>
            <select
                id="semester"
                name="semester"
                required
        ...
        {{-- Enrollment Status --}}
        <div>
            <label for="enrollment_status" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.enrollment_status') }} <span class="text-red-500">*</span></label>
            <select
                id="enrollment_status"
                name="enrollment_status"
                required
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
                       {{ $errors->has('enrollment_status') ? 'border-red-400 bg-red-50 focus:ring-red-300' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 dark:focus:ring-blue-800' }}
                       focus:outline-none focus:ring-2"
            >
        ...
        {{-- GPA --}}
        <div>
            <label for="gpa" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.gpa') }} <span class="text-xs font-normal text-gray-400">({{ __('common.optional') }}, 0.00–4.00)</span></label>
            <input
                id="gpa"
                type="number"
                name="gpa"
                ...
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
                       {{ $errors->has('gpa') ? 'border-red-400 bg-red-50 focus:ring-red-300' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 dark:focus:ring-blue-800' }}
                       focus:outline-none focus:ring-2"
            />
            @error('gpa')
                <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
        ...
        {{-- Enrolled At --}}
        <div>
            <label for="enrolled_at" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.enrolled_at_form') }} <span class="text-red-500">*</span></label>
            <input
                id="enrolled_at"
                type="date"
                name="enrolled_at"
                ...
                required
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
                       {{ $errors->has('enrolled_at') ? 'border-red-400 bg-red-50 focus:ring-red-300' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 dark:focus:ring-blue-800' }}
                       focus:outline-none focus:ring-2"
            />
            @error('enrolled_at')
                <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
        ...
        {{-- Graduated At --}}
        <div>
            <label for="graduated_at" class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1.5">{{ __('students.graduated_at') }} <span class="text-xs font-normal text-gray-400">({{ __('common.optional') }})</span></label>
            <input
                id="graduated_at"
                type="date"
                name="graduated_at"
                ...
                class="w-full px-3.5 py-2.5 rounded-lg border text-sm transition-colors bg-white dark:bg-gray-700 dark:text-gray-200
                       {{ $errors->has('graduated_at') ? 'border-red-400 bg-red-50 focus:ring-red-300' : 'border-gray-300 dark:border-gray-600 focus:border-blue-500 focus:ring-blue-200 dark:focus:ring-blue-800' }}
                       focus:outline-none focus:ring-2"
            />
            @error('graduated_at')
                <p class="mt-1.5 text-xs text-red-600">{{ $message }}</p>
