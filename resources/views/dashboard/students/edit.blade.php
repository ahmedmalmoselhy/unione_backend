...
@section('title', __('students.edit_student'))
@section('heading', __('students.edit_student'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.students.update', $student) }}" enctype="multipart/form-data" class="space-y-5">
            @csrf
            @method('PUT')
