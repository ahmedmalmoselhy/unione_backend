...
@section('title', __('enrollments.edit_enrollment'))
@section('heading', __('enrollments.edit_enrollment'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.enrollments.update', $enrollment) }}" class="space-y-5">
            @csrf
            @method('PUT')

            @include('dashboard.enrollments._form')
