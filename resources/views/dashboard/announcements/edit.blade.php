...
@section('title', __('announcements.edit_announcement'))
@section('heading', __('announcements.edit_announcement'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.announcements.update', $announcement) }}" class="space-y-5">
            @csrf
            @method('PUT')

            @include('dashboard.announcements._form')
