...
@section('title', __('courses.new_course'))
@section('heading', __('courses.new_course'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white dark:bg-gray-800 rounded-2xl border border-gray-200 dark:border-gray-700 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.courses.store') }}" class="space-y-5">
            @csrf

            @include('dashboard.courses._form', ['course' => null])
