...
@section('title', __('courses.edit_course'))
@section('heading', __('courses.edit_course'))
...
<div class="max-w-2xl">
    ...
    <div class="bg-white rounded-2xl border border-gray-200 p-6">
        ...
        <form method="POST" action="{{ route('dashboard.courses.update', $course) }}" class="space-y-5">
            @csrf
            @method('PUT')
